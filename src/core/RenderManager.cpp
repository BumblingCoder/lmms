...
RenderManager::~RenderManager() { delete m_activeRenderer; }
...
void RenderManager::renderNextTrack()
{
	...
	else
	{
		...
		m_activeRenderer =
		    new ProjectRenderer( m_qualitySettings, m_outputSettings, m_format,
...
{
	m_activeRenderer = new ProjectRenderer( m_qualitySettings, m_outputSettings,
	                                        m_format, m_outputPath );
