...
public:
	...
	bool connectPort( const ladspa_key_t & _plugin, LADSPA_Handle _instance,
	                  uint32_t _port, LADSPA_Data * _data_location );
	...
	bool run( const ladspa_key_t & _plugin, LADSPA_Handle _instance,
	...
	bool runAdding( const ladspa_key_t & _plugin, LADSPA_Handle _instance,
	                uint32_t _sample_count );
	...
	bool setRunAddingGain( const ladspa_key_t & _plugin,
	                       LADSPA_Handle _instance, LADSPA_Data _gain );
