...
public:
	...
	QString defaultArtworkDir() const { return m_dataDir + DEFAULT_THEME_PATH; }

	QString artworkDir() const { return m_artworkDir; }
	...
	const QString & ladspaDir() const { return m_ladDir; }
	...
	const QString & defaultSoundfont() const { return m_defaultSoundfont; }
#endif

	const QString & backgroundArtwork() const { return m_backgroundArtwork; }
	...
	const QString & value( const QString & cls, const QString & attribute,
