...
public:
	...
	/*! \brief This method converts frequency to wavelength, but you can use any
	 * custom sample rate with it.
	 */
	 ...
	 */
	static inline sample_t oscillate( float _ph, float _wavelen,
	                                  Waveforms _wave )
	{
		...
		/*		lookup = lookup << 1;
		        ...
		        const sample_t s4 = s_waveforms[ _wave ].sampleAt( t, ( lookup +
		   1 ) % tlen ); const sample_t s34 = linearInterpolate( s3, s4, ip );
