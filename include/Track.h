...
public:
	...
	inline const MidiTime & startPosition() const { return m_startPosition; }
...
protected:
	...
	DataFile
	createTCODataFiles( const QVector<TrackContentObjectView *> & tcos ) const;
...
protected:
	...
	virtual QString nodeName() const { return "trackview"; }
